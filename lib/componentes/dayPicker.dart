...
class DayPickerSpinner extends StatefulWidget {
  final DateTime time;
  ...
  @override
  _DayPickerSpinnerState createState() => _DayPickerSpinnerState();
}

class _DayPickerSpinnerState extends State<DayPickerSpinner> {
  ...
  final items = ['', 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sáb'];
  ...
  Widget spinner(int max, int selectedIndex, bool isScrolling, int interval,
