...
class UserForm3 extends StatefulWidget {
  ...
  @override
  UserForm3State createState() => UserForm3State();
}

class UserForm3State extends State<UserForm3> {
                  ...
                  showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          onPressed: () async {
                            await UsersDatabase.instance.deleteEst(user.id);
                        ...
                        IconButton(
                          onPressed: () {
                            showDatePicker(
                              ...
                              await UsersDatabase.instance.updateEst(user1);
                            });
                          },
                          icon: Icon(
                  ...
                  setState(
                    () {
                      model.scheduleNotification(
                        _formData['idN'],
                        'Dia de estudo',
                        'Hoje é dia do estudo de ${_formData['name']}',
              ...
              child: Consumer<NotificationService>(
                builder: (context, model, _) => CupertinoDatePicker(
                    ...
                    initialDateTime: DateTime(
                        ...
                        _formData['minute'] == null ? 30 : _formData['minute'],
                        0),
